...
var file_warehouse_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x03, 0x61, 0x70, 0x69, 0x1a, 0x0d, 0x70, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x3a, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x50, 0x61, 0x63, 0x6b,
	0x61, 0x67, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x21,
	...
	0x65, 0x32, 0x4e, 0x0a, 0x0c, 0x57, 0x61, 0x72, 0x65, 0x68, 0x6f, 0x75, 0x73, 0x65, 0x41, 0x50,
	0x49, 0x12, 0x3e, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x50, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x49,
	0x6e, 0x66, 0x6f, 0x12, 0x1a, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x47, 0x65, 0x74, 0x50, 0x61, 0x63,
	0x6b, 0x61, 0x67, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x10, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x50, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x49, 0x6e, 0x66,
	0x6f, 0x42, 0x05, 0x5a, 0x03, 0x61, 0x70, 0x69, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_warehouse_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_warehouse_proto_goTypes = []interface{}{
	(*GetPackageInfoRequest)(nil), // 0: api.GetPackageInfoRequest
	(*PackageInfo)(nil),           // 1: api.PackageInfo
}
var file_warehouse_proto_depIdxs = []int32{
	0, // 0: api.WarehouseAPI.GetPackageInfo:input_type -> api.GetPackageInfoRequest
	1, // 1: api.WarehouseAPI.GetPackageInfo:output_type -> api.PackageInfo
...
func (c *warehouseAPIClient) GetPackageInfo(ctx context.Context, in *GetPackageInfoRequest, opts ...grpc.CallOption) (*PackageInfo, error) {
	out := new(PackageInfo)
	err := c.cc.Invoke(ctx, "/api.WarehouseAPI/GetPackageInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedWarehouseAPIServer can be embedded to have forward compatible implementations.
type UnimplementedWarehouseAPIServer struct {
}

func (*UnimplementedWarehouseAPIServer) GetPackageInfo(context.Context, *GetPackageInfoRequest) (*PackageInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPackageInfo not implemented")
}

func RegisterWarehouseAPIServer(s *grpc.Server, srv WarehouseAPIServer) {
	s.RegisterService(&_WarehouseAPI_serviceDesc, srv)
}

func _WarehouseAPI_GetPackageInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetPackageInfoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WarehouseAPIServer).GetPackageInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.WarehouseAPI/GetPackageInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WarehouseAPIServer).GetPackageInfo(ctx, req.(*GetPackageInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _WarehouseAPI_serviceDesc = grpc.ServiceDesc{
	ServiceName: "api.WarehouseAPI",
	HandlerType: (*WarehouseAPIServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetPackageInfo",
			Handler:    _WarehouseAPI_GetPackageInfo_Handler,
		},
	},
